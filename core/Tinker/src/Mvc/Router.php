...
{	
	...
	{
		return $camelize?$this->camelize($this->plugin):$this->plugin;
	}
	...
	{
		return $camelize?$this->camelize($this->controller):$this->controller;
	}
	...
	{
		return $camelize?$this->camelize($this->action):$this->action;
	}
